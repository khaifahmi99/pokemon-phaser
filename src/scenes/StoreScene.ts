...
export default class StoreScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.tilemapTiledJSON('store', 'assets/store.json');
  ...
  create() {
    ...
    this.hero = this.physics.add.sprite(420, 220, 'hero').setScale(1);
    ...
    this.physics.add.collider(this.hero, furniture);
    furniture.setCollisionBetween(0, 9999);
